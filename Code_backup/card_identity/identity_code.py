...
# 文件路径
dir_list = os.listdir('E:/E_Disk/Code/PyCharm/pythonProject/Card_Identity/image')
print (dir_list)
path = os.path.join('./image', dir_list)
print (path)
...
ap.add_argument("-i", "--image", default=path, required=False, help="path to input image")
...
# 将符合的轮廓从左到右排序
locs = sorted(locs, key=lambda x_x: x_x[0])
output = []
